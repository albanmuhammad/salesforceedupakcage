...
type ApiData = {
  progress: { Id: string; Name: string; StageName: string; AccountId: string; RecordType?: { Name?: string | null } | null; };
      ...
      <div className="w-full max-w-7xl">
        <header className="mb-6">
          <h1 className="text-2xl font-semibold text-white drop-shadow-sm">
            [{progress.RecordType?.Name}] {progress.Name} - {progress.Id}
          </h1>
        </header>
        ...
        <ProgressClient
          ...
          recordTypeName={progress.RecordType?.Name}
        />
      </div>
    </main>
  );
